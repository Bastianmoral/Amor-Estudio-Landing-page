...
export default function Home() {
  return  ( 
  <div class="body-home">
  <svg class="vector-arrow" width="54" height="214" xmlns="http://www.w3.org/2000/svg">
    <path
  ...
  <svg class="vector-line" width="1829" height="670" xmlns="http://www.w3.org/2000/svg">
  ...
  <main class="container">
   ...
   <a href="https://www.instagram.com/amor.estgr/?hl=en" class="ig-container">Instagram</a>
   <a href="https://www.behance.net/gallery/113078441/amorestgr-Branding" class="behance-container">Behance</a>
